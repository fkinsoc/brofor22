            ...
            <div key={alert.id} className="bg-[#111111] border border-zinc-800 rounded-lg p-6 flex flex-col sm:flex-row gap-5 hover:border-zinc-700 transition-colors">
              ...
              <div className="flex-1">
                ...
                <div className="mt-5 flex items-center gap-3">
                  <Link to={`/parcels/${alert.parcel.id}`} className="text-[10px] uppercase font-bold tracking-wider bg-[#0A0A0A] hover:bg-zinc-800 text-white px-4 py-2 rounded transition-colors border border-zinc-800">
                    View Parcel
                  </Link>
