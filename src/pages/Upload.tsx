    ...
    <AppLayout>
      <div className="max-w-4xl mx-auto">
        <div className="mb-6">
          ...
          <p className="text-sm text-zinc-500 dark:text-zinc-400 mt-1">Upload historical land acquisition data to train or run the ML pipeline.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="md:col-span-2 space-y-6">
            ...
            >
              <UploadCloud className={`w-12 h-12 mb-4 ${file ? 'text-amber-500' : 'text-text-secondary dark:text-zinc-500'}`} />
              ...
              {!file && (
                <label className="px-4 py-2 bg-zinc-800 hover:bg-zinc-700 text-text-primary dark:text-white text-sm font-medium rounded-md cursor-pointer transition-colors border border-zinc-700">
                  Select File
              ...
              {file && !uploading && !result && (
                <div className="flex gap-3">
                  <button onClick={handleUpload} className="px-4 py-2 bg-amber-700 hover:bg-amber-600 text-text-primary dark:text-white text-sm font-medium rounded-md transition-colors">
                    Process Dataset
                  </button>
                  <button onClick={() => setFile(null)} className="px-4 py-2 bg-zinc-800 hover:bg-zinc-700 text-zinc-600 dark:text-zinc-300 text-sm font-medium rounded-md transition-colors border border-zinc-700">
                    Cancel
                  </button>
                </div>
              )}
            ...
            {uploading && (
              <div className="bg-background-secondary dark:bg-[#111111] border border-border-subtle dark:border-zinc-800 rounded-xl p-6 shadow-sm">
                ...
                <div className="mt-6">
                  <div className="flex justify-between text-xs text-text-secondary dark:text-zinc-500 mb-1">
              ...
              <div className="bg-emerald-900/10 border border-emerald-900/30 rounded-xl p-6 shadow-sm">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-zinc-500 dark:text-zinc-400">Dataset successfully analyzed and scored.</p>
                  </div>
                </div>
                
                <div className="grid grid-cols-3 gap-4 mt-6">
                   <div className="bg-zinc-900/50 rounded-lg p-3 border border-border-subtle dark:border-zinc-800/50">
                     <div className="text-xs text-text-secondary dark:text-zinc-500 mb-1">Total Records</div>
                     <div className="text-xl font-bold text-text-primary dark:text-white">{result.totalRows}</div>
                   </div>
                   <div className="bg-zinc-900/50 rounded-lg p-3 border border-border-subtle dark:border-zinc-800/50">
                     <div className="text-xs text-text-secondary dark:text-zinc-500 mb-1">Valid Records</div>
                     <div className="text-xl font-bold text-emerald-500">{result.validRows}</div>
                   </div>
                   <div className="bg-zinc-900/50 rounded-lg p-3 border border-border-subtle dark:border-zinc-800/50">
                     <div className="text-xs text-text-secondary dark:text-zinc-500 mb-1">Warnings/Errors</div>
                     <div className="text-xl font-bold text-amber-500">{result.errors}</div>
                   </div>
                </div>
                
                <div className="mt-6 flex gap-3">
                  <button onClick={() => {setResult(null); setFile(null); setProgress(0);}} className="text-sm font-medium text-zinc-500 dark:text-zinc-400 hover:text-text-primary dark:text-white transition-colors">
                    Upload Another File
                  </button>
                </div>
              </div>
          ...
          <div className="space-y-6">
            <div className="bg-background-secondary dark:bg-[#111111] border border-border-subtle dark:border-zinc-800 rounded-xl p-5 shadow-sm">
              ...
              <ul className="space-y-2 text-xs font-mono text-zinc-600 dark:text-zinc-300">
              ...
              <button className="mt-6 w-full flex items-center justify-center gap-2 py-2 bg-zinc-800 hover:bg-zinc-700 text-zinc-600 dark:text-zinc-300 rounded-md text-sm transition-colors border border-zinc-700">
